...
LOAD DATA LOCAL INFILE '/tmp/data/FD_GROUP.txt' INTO TABLE FD_GROUP FIELDS TERMINATED BY '^' ENCLOSED BY '\~';
LOAD DATA LOCAL INFILE '/tmp/data/FOOD_DES.txt' INTO TABLE FOOD_DES FIELDS TERMINATED BY '^' ENCLOSED BY '\~';
LOAD DATA LOCAL INFILE '/tmp/data/DATA_SRC.txt' INTO TABLE DATA_SRC FIELDS TERMINATED BY '^' ENCLOSED BY '\~';
LOAD DATA LOCAL INFILE '/tmp/data/DERIV_CD.txt' INTO TABLE DERIV_CD FIELDS TERMINATED BY '^' ENCLOSED BY '\~';
LOAD DATA LOCAL INFILE '/tmp/data/FOOTNOTE.txt' INTO TABLE FOOTNOTE FIELDS TERMINATED BY '^' ENCLOSED BY '\~';
LOAD DATA LOCAL INFILE '/tmp/data/LANGDESC.txt' INTO TABLE LANGDESC FIELDS TERMINATED BY '^' ENCLOSED BY '\~';
LOAD DATA LOCAL INFILE '/tmp/data/WEIGHT.txt' INTO TABLE WEIGHT FIELDS TERMINATED BY '^' ENCLOSED BY '\~';
LOAD DATA LOCAL INFILE '/tmp/data/NUTR_DEF.txt' INTO TABLE NUTR_DEF FIELDS TERMINATED BY '^' ENCLOSED BY '\~';
LOAD DATA LOCAL INFILE '/tmp/data/LANGUAL.txt' INTO TABLE LANGUAL FIELDS TERMINATED BY '^' ENCLOSED BY '\~';
LOAD DATA LOCAL INFILE '/tmp/data/SRC_CD.txt' INTO TABLE SRC_CD FIELDS TERMINATED BY '^' ENCLOSED BY '\~';
LOAD DATA LOCAL INFILE '/tmp/data/DATSRCLN.txt' INTO TABLE DATSRCLN FIELDS TERMINATED BY '^' ENCLOSED BY '\~';
LOAD DATA LOCAL INFILE '/tmp/data/NUT_DATA.txt' INTO TABLE NUT_DATA FIELDS TERMINATED BY '^' ENCLOSED BY '\~';
